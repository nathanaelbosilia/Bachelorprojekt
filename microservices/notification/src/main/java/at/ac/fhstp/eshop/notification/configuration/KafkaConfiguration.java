...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, ShipmentCreatedEvent> shipmentCreatedEventConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
        ...
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        config.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class.getName());
        config.put(JsonDeserializer.TYPE_MAPPINGS, "ShipmentCreatedEvent:" + ShipmentCreatedEvent.class.getName());
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "at.ac.fhstp.eshop.shipping.events"); // optional fallback
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ShipmentCreatedEvent> shipmentCreatedEventListener() {
        ConcurrentKafkaListenerContainerFactory<String, ShipmentCreatedEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();

        factory.setConsumerFactory(shipmentCreatedEventConsumerFactory());
        factory.getContainerProperties().setAckMode(ContainerProperties.AckMode.RECORD);
        factory.setCommonErrorHandler(errorHandler());
